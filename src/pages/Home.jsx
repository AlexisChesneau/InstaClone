...
export default function Home() {
  return (
    <>
      <div className="bg-black flex h-[2.75rem] w-full items-center justify-between px-4 fixed top-0 z-100 border-b border-[#363636]">
        <div className="flex">
      ...
      <div className="h-[6.313rem] mt-11 bg-[#121212] flex items-center border-b border-[#363636]">
